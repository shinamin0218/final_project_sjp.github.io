...
ggplotly(box_ggplot) %>%
  layout(
    ...
    yaxis = list(title = "Total Infant Deaths")
  )

print(ggplotly(box_ggplot))
```

The boxplot `box_ggplot` above shows a plot of infant deaths categorized by whether they were Hispanic or not. The graph shows that those who were not Hispanic had a higher infant death count than those who were Hispanic.
...
This graph compares the distribution of infant mortality to mothers who were or were not recipients of medicaid. This density graph shows that there is no significant statistical difference. 
...
plot_mortality_intent =
  ...
  ggplot(aes(x = break_out, y = sample_size, color = break_out)) +
  geom_point(alpha = 0.5) +
  theme(legend.position = "none") +
  labs(title = "Infant Deaths by Maternal Intent",
       x = "Maternal Intent",
       y = "Total Infant Deaths") +
  scale_fill_viridis(discrete = TRUE, name = "Maternal Intent")
