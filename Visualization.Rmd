...
This `scatter plot` shows the relationship between maternal intent to have children with infant mortality rate. Those who intended to have a child, actually had a higher rate of infant mortality rate. There could be several confounding factors that could contribute to this, such as age and stress factors. 
