...
### Alcohol use during pregnancy
  ...
  * According to Wolfe et al., within a dataset comprising 4,536,701 birth records, 1.20% exhibited diagnostic codes related to drug or alcohol discharge (n = 54,290). The unadjusted Relative Risks (RRs) for maternal (RR = 2.7), fetal (RR = 1.3), neonatal (RR = 2.4), and post-neonatal (RR = 4.3) mortality were elevated among births diagnosed with drug or alcohol-related conditions. [Reference](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3349286/)
